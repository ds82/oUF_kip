  ...
  local mediaFolder = "Interface\\AddOns\\oUF_kip\\media\\"	-- don't touch this ...
  ...
  -- Positioning
  cfg.PlayerX = -320 -- Player frame's x-offset position from the relative point of the screen
  ...
  cfg.TargetX = -320 -- Target frame's x-offset position from the relative point of the screen
  ...
  cfg.TotY = -45 -- Target of target frame's y-offset position from the relative point of the screen
  cfg.TotRelativePoint = "BOTTOMRIGHT" -- Target of target frame's reference point of the screen used for X and Y offsets. Possible values are: "TOP"/"BOTTOM"/"LEFT"/"RIGHT"/"CENTER"/"TOPLEFT"/"ROPRIGHT"/"BOTTOMLEFT"/"BOTTOMRIGHT"  cfg.PartyX = -290 -- Party Frames Horizontal Position
  cfg.FocusX = 0 -- Focus frame's x-offset position from the relative point of the screen
  cfg.FocusY = 320 -- Focus frame's y-offset position from the relative point of the screen
  cfg.FocusRelativePoint = "CENTER" -- Focus frame's reference point of the screen used for X and Y offsets. Possible values are: "TOP"/"BOTTOM"/"LEFT"/"RIGHT"/"CENTER"/"TOPLEFT"/"ROPRIGHT"/"BOTTOMLEFT"/"BOTTOMRIGHT"  cfg.PartyX = -290 -- Party Frames Horizontal Position
  ...
  cfg.showClassIcons = true -- Shadow orbs, holy power and chi
  cfg.showShards = true -- warlock bars
